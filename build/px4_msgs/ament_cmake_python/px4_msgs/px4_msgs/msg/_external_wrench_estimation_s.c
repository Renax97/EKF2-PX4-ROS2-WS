...
bool px4_msgs__msg__external_wrench_estimation__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._external_wrench_estimation.ExternalWrenchEstimation", full_classname_dest, 65) == 0);
  }
  px4_msgs__msg__ExternalWrenchEstimation * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of ExternalWrenchEstimation */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._external_wrench_estimation");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ExternalWrenchEstimation");
