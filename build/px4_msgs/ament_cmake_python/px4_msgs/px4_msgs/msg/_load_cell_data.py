...
class Metaclass_LoadCellData(type):
    """Metaclass of message 'LoadCellData'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.LoadCellData')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__load_cell_data
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__load_cell_data
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__load_cell_data
            cls._TYPE_SUPPORT = module.type_support_msg__msg__load_cell_data
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__load_cell_data
    ...
    def ORB_QUEUE_LENGTH(self):
        ...
        return Metaclass_LoadCellData.__constants['ORB_QUEUE_LENGTH']


class LoadCellData(metaclass=Metaclass_LoadCellData):
    """
    Message class 'LoadCellData'.
