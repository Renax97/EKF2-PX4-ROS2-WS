...
foreach(_expectedTarget trajectory_planner::frame_transforms)
...
# Create imported target trajectory_planner::frame_transforms
add_library(trajectory_planner::frame_transforms SHARED IMPORTED)

set_target_properties(trajectory_planner::frame_transforms PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/usr/include/eigen3;${_IMPORT_PREFIX}/include/trajectory_planner;${_IMPORT_PREFIX}/include"
