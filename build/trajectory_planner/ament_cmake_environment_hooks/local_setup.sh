...
: ${AMENT_CURRENT_PREFIX:="/home/renato/ws_sensor_combined/install/trajectory_planner"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/trajectory_planner/environment/library_path.sh"
